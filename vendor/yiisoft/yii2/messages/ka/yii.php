...
return [
    ...
    'The file "{file}" is too big. Its size cannot exceed {limit, number} {limit, plural, one{byte} other{bytes}}.' => 'ფაილი «{file}» ძალიან დიდია. ზომა არ უნდა აღემატებოდეს {limit, number} {limit, plural, one{ბაიტს} few{ბაიტს} many{ბაიტს} other{ბაიტს}}.',
    'The file "{file}" is too small. Its size cannot be smaller than {limit, number} {limit, plural, one{byte} other{bytes}}.' => 'ფაილი «{file}» ძალიან პატარაა. ზომა უნდა აღემატებოდეს {limit, number} {limit, plural, one{ბაიტს} few{ბაიტს} many{ბაიტს} other{ბაიტს}}.',
